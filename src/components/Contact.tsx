        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white">contact@aiexpert.com</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-3">
            <form
              ...
              className="bg-tech-light-gray/10 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="bg-tech-light-gray/30 border-gray-700 focus:border-tech-teal"
                  />
                </div>
                <div className="space-y-2">
                  <label
              ...
              <div className="space-y-2 mb-6">
                ...
                <Textarea
                  ...
                  rows={6}
                  required
                  className="bg-tech-light-gray/30 border-gray-700 focus:border-tech-teal resize-none"
                />
              </div>

              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-tech-teal to-tech-blue hover:from-tech-blue hover:to-tech-teal transition-all duration-300"
